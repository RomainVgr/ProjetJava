package com.morpion.romain;
	...
	public class program {
		...
		public static void main(String[] args) {
			...
			System.out.println("Le premier joueur à jouer est le joueur "+ joueurEnCours+ " ! \n");
			...
			while (!jeuFini) {
				...
				System.out.print(" Joueur " + joueurEnCours+ " Saisissez un nombre entre 1 et 9 : \n");  // Saisie et choix d'une case dans la grille
				...
				if (jeton < 1 || jeton > grille.length ) {										// Si la case sélectionnée est bien présente dans la grille (Entre 1 et 9)
					System.out.println("Chiffre Incorrect ! \n"  );
							...
							if (grille[jeton-1] == jo || grille[jeton-1] == jx) {						// Si la case sélectionnée n'a pas deja été prise par l'autre joueur
								System.out.println("Case déjà choisie ! \n");
